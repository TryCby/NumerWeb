// src/calculate/Linear_Algebra_Equations/ui/GaussSeidel.jsx
import { useState } from 'react';
import { GaussSeidel } from '../logic/GaussSeidel';
...
function GaussSeidelUI() {
    ...
    const handleCalculate = () => {
        try {
            ...
            const gaussSeidel = new GaussSeidel(n, tol);
            const output = gaussSeidel.calculate(matrixA, matrixB, initialX);
            setResult(output);
        } catch (error) {
    ...
    return (
        <div>
            ...
            {result && (
                <>
                    <MatrixSolution result={result} methodType="gaussseidel" />
